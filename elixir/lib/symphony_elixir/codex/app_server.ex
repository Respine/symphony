defmodule SymphonyElixir.Codex.AppServer do
  ...
  require Logger
  alias SymphonyElixir.{Codex.DynamicTool, Config, SSH, WorkspaceGuard}
  ...
  defp validate_workspace_cwd(workspace, worker_host) do
    WorkspaceGuard.validate(workspace, worker_host)
  end
