defmodule SymphonyElixir.AgentRunner do
  ...
  defp run_codex_turns(workspace, issue, codex_update_recipient, opts, worker_host) do
    ...
    # Bind the backend once per attempt: a session must not outlive a workflow
    # reload that switches agent.kind.
    opts = Keyword.put(opts, :backend, Config.agent_backend())
